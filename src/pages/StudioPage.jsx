         ...
         <Card sx={{ display: 'flex', maxWidth: 1200, p: 2, boxShadow: 'none', border: 'none' }}>
            ...
            <CardContent sx={{ flex: 1, ml: 2 }}>
               <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Button variant="contained" sx={{ backgroundColor: 'black', color: 'white', fontSize: '12px', ml: 1, px: 1.5, py: 0.5, '&:hover': { backgroundColor: '#333' }, boxShadow: 'none' }}>
                     구독
                  </Button>
               </Box>
               ...
               <Typography variant="body2" sx={{ mt: 1, fontSize: '14px' }}>
                  달성 프로젝트 <span style={{ color: '#4caf50' }}>3건</span> | 구독자 수 <span style={{ color: '#4caf50' }}>82명</span> | 최대 달성률 <span style={{ color: '#4caf50' }}>1125%</span>
               </Typography>
            </CardContent>
         </Card>
